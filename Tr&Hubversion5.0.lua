spawn(function() 
    ...
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Discord : Join Tr & Hub Discord to Get the Latest Information <Color=/>"):Display()
end)
----------------------------------------------------------------------------------------------------------------------------------------------
...
local Window =
    ...
    {
        Title = "Tr & Hub",
        SubTitle = "creator by setup Tr & Hub",
        TabWidth = 160,
...
do
    Tabs.Discord:AddButton(
        {
            Title = "Copy Link Discord Tr & Hub",
            Description = "https://discord.com/invite/wuktNz7p",
            Callback = function()
                setclipboard("https://discord.com/invite/wuktNz7p")
                Fluent:Notify(
                    {
                        Title = "https://discord.com/invite/wuktNz7p",
                        Content = "Copied!",
                        SubContent = "", -- Optional
    ...
    Tabs.Discord:AddButton(
        {
            Title = "Copy Link discord https://discord.com/invite/wuktNz7p",
            Description = "Tr & Hub ",
            Callback = function()
                setclipboard("Tr & Hub")
                Fluent:Notify(
